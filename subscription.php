...
<html>
	<head>
		...
		<link href="css/subscription.css" rel="stylesheet" type="text/css" media="all"/>
	...
	<body>
		...
		<div class="priceing-table w3l">
			<div class="wrap">
				<h1>Online Course Buy Special Price</h1>
						...
						<div class="price-grid">
							<div class="price-block agile">
								...
								<div class="price-selet pric-sclr2">
									<a class="popup-with-zoom-anim" data-plan="standart" data-price="10.00" href="checkout.php">Sign Up</a>
                                    <a class="btn btn-primary text-white font-weight-bolder float-right" href="checkout.php">Subscription</a>
								</div>
							</div>
						</div>
