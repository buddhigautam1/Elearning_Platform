    ...
    <div class="container-fluid remove-vid-marg">
      ...
      <div class="vid-content" >
        ...
        <?php    
          ...
          ?> 
<!--
<a  class="btn btn-danger mt-3" href="" data-toggle="modal" data-target="#stuRegModalCenter">Subscriptions</a>
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          <div class="col-sm">
            <h5>About Us</h5>
              <p>We provides universal access to the world’s best education, partnering with top universities and organizations to offer courses online.</p>
          </div>
          <div class="col-sm">
            <h5>Category</h5>
          ...
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>Onlinecourse <br> Mehsana<br> Ganpat University<br> Ph. +9779866989843 </p>
          </div>
        </div>
      </div>
